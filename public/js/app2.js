...
function renderHeader() {
  ...
  return h('header', { class: 'header' }, [
    h('div', { style: { display:'flex', alignItems:'center' } }, [
      h('div', { class: 'logo', style: { display:'flex', alignItems:'center', gap:'10px' } }, [
        _cachedLogo
          ? h('img', { src: _cachedLogo, style: { height:'32px', borderRadius:'4px' } })
...
function renderFundBackoffice(cnpj) {
  ...
  return h('div', { class: 'content fade-up' }, [
    ...
    // Compute risk for this fund
    (() => { try { state._bo_risk = selected ? computeRiskAnalysis(selected) : null; } catch(e) { state._bo_risk = null; } })(),

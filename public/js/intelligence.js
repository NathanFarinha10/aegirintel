...
const NAV_SECTIONS = {
  ...
  macrointel: {
    ...
    items: [
      ...
      { id: 'mi_realestate',  label: 'Mercado Imobiliário',    num: '02' },
  ...
  assetmgmt: {
    ...
    items: [
      ...
      { id: 'am_carteiras',  label: 'Carteiras Mensais',      num: '02' },
      { id: 'am_teses',      label: 'Teses de Investimento',  num: '03' },
      { id: 'am_comite',     label: 'Comitê & Atas',          num: '04' },
      { id: 'am_research',   label: 'Research',               num: '05' },
      { id: 'am_new',        label: '+ Novo Fundo',           num: '06' },
    ]
  },
  strategy: {

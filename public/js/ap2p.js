...
function _renderInternal() {
  ...
  // Fund detail view (when a fund card is clicked)
  if (state.detail && state.detail.kind === 'fund') {
    ...
    switch(v) {
      ...
      case 'am_new':      state._fund_edit = emptyFund(); state.view = 'am_edit'; content = renderFundForm(); break;

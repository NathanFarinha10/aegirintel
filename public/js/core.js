...
function _renderInternal() {
  ...
  if (state.detail) {
    ...
    switch (state.view) {
      ...
      case 'sec_portfolios': content = renderPortfolios(); break;
      ...
      case 'am_carteiras':  content = renderCarteiras(); break;
      case 'am_teses':      content = renderTeses(); break;
      case 'am_comite':     content = renderComite(); break;
      case 'am_research':   content = renderResearch(); break;

...
function renderEstoquesEmbed() {
  return h('div', { class: 'content fade-up', style: { padding: 0, height: 'calc(100vh - 48px)' } }, [
    h('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '12px 20px', borderBottom: '1px solid var(--border)' } }, [
      h('div', {}, [
        h('div', { style: { fontFamily: 'Fraunces, serif', fontSize: '16px' } }, 'Gestão de Estoques'),
        h('div', { class: 'mono', style: { fontSize: '10px', color: 'var(--text-faint)' } }, 'Estoque imobiliário · Base compartilhada'),
      ]),
      h('button', { class: 'btn-secondary', style: { fontSize: '10px' }, onClick: () => window.open('/estoques.html', '_blank') }, 'Abrir em nova aba ↗'),
    ]),
    h('iframe', { src: '/estoques.html', style: { width: '100%', height: '100%', border: 'none' } }),
  ]);
}

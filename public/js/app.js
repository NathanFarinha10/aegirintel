...
function renderEstoquesEmbed() {
  return h('div', { style: { position: 'absolute', top: '48px', left: 0, right: 0, bottom: 0, display: 'flex', flexDirection: 'column' } }, [
    h('div', { style: { display: 'flex', justifyContent: 'space-between', alignItems: 'center', padding: '8px 20px', borderBottom: '1px solid var(--border)', flexShrink: 0, background: 'var(--bg-2)' } }, [
      h('div', {}, [
    ...
    h('iframe', { src: '/estoques.html', style: { flex: 1, width: '100%', border: 'none' } }),
  ]);
}

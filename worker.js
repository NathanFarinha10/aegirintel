...
const ALLOWED_SOURCES = {
  ...
  bcb_imob: {
    ...
    buildUrl: (params) => {
      ...
      if (params.discover) {
        // Fetch a sample to discover available series names
        return `https://olinda.bcb.gov.br/olinda/servico/MercadoImobiliario/versao/v1/odata/mercadoimobiliario?$format=json&$top=${top}&$select=Data,Info,Valor&$orderby=Data desc`;
      }
